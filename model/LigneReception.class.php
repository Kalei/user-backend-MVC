...
/**
 * Description of Ligne Reception
 *
...
class LigneReception {
    ...
    public function save() {
        ...
        if (!empty($this->id)) {
            $sql = " UPDATE lignereception SET ";
            $set = array();

            foreach ($this->data as $att => $value) {
                $strip_value = $this->stripslashes_array($value);
                if ($att != 'id' && $att != 'id_ligne' && $value) {
            ...
            $sql = " INSERT INTO lignereception ";
            ...
            $query = "SELECT id_ligne FROM lignereception ORDER BY id_ligne DESC LIMIT 0 , 1";
            try {
