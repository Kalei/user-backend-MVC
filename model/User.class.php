...
class User {
     ...
     public function save() {
          ...
          if (!empty($this->id)) {
               ...
               foreach ($this->data as $att => $value) {
                    ...
                    if ($att != 'id' && $att != 'id_user' && (!empty($value) || $value === 0)) {
               ...
               $query = "SELECT id_user FROM user ORDER BY id_user DESC LIMIT 0 , 1";
               try {
     ...
     public function getAffectations() {
          return affectationUserTable::getAffectationUserByIdUser($this->id_user);
     }
