...
/**
 * Description of Ligne CaisseFoire
 *
 * @author Hugo Rovelli
 */
class LigneCaisseFoire {
     ...
     public function save() {
          ...
          if (!empty($this->id)) {
               ...
               foreach ($this->data as $att => $value) {
                    ...
                    if ($att != 'id' && $att != 'id_lignecaisse' && $att != 'id_caisse_foire' && isset($value)) {
               ...
               $query = "SELECT id_lignecaisse FROM lignecaisse_foire ORDER BY id_lignecaisse DESC LIMIT 0 , 1";
               try {
