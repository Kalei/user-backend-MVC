    ...
    public function save() {
        ...
        if (!empty($this->id)) {
            ...
            foreach ($this->data as $att => $value) {
                ...
                if ($att != 'id' && $att != 'id_reception' && $value) {
                    $set[] = " $att = " . $pdo->quote($strip_value) . " ";
                }
            }

            $sql .= implode(",", $set);
            $sql .= " WHERE id_reception =" . $this->id_reception;
            ...
            $query = "SELECT id_reception FROM reception ORDER BY id_reception DESC LIMIT 0 , 1";
            try {
